...
print("Default".rjust(20,"-"))
print(count)

print("\n")
print("Using pprint".rjust(20,"-"))
import pprint
pprint.pprint(count) #print line by line

print("\n")
print("pprint pformat".rjust(20,"-"))
text = pprint.pformat(count) #store into a var
print(text)
